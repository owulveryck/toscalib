...
// sources:
// NormativeTypes/tosca.capabilities.Attachement
// NormativeTypes/tosca.capabilities.Container
// NormativeTypes/tosca.capabilities.Endpoint
// NormativeTypes/tosca.capabilities.Endpoint.Admin
// NormativeTypes/tosca.capabilities.Endpoint.Database
// NormativeTypes/tosca.capabilities.Endpoint.Public
// NormativeTypes/tosca.capabilities.Network.Bindable
// NormativeTypes/tosca.capabilities.Node
// NormativeTypes/tosca.capabilities.OperatingSystem
// NormativeTypes/tosca.capabilities.Root
// NormativeTypes/tosca.capabilities.Scalable
// NormativeTypes/tosca.interfaces.node.lifecycle.Standard
// NormativeTypes/tosca.interfaces.relationship.Configure
// NormativeTypes/tosca.nodes.BlockStorage
// NormativeTypes/tosca.nodes.Compute
// NormativeTypes/tosca.nodes.Container.Application
// NormativeTypes/tosca.nodes.Container.Runtime
// NormativeTypes/tosca.nodes.DBMS
// NormativeTypes/tosca.nodes.Database
// NormativeTypes/tosca.nodes.LoadBalancer
// NormativeTypes/tosca.nodes.ObjectStorage
// NormativeTypes/tosca.nodes.Root
// NormativeTypes/tosca.nodes.SoftwareComponent
// NormativeTypes/tosca.nodes.WebApplication
// NormativeTypes/tosca.nodes.WebServer
// NormativeTypes/tosca.relationships.AttachesTo
// NormativeTypes/tosca.relationships.ConnectsTo
// NormativeTypes/tosca.relationships.DependsOn
// NormativeTypes/tosca.relationships.HostedOn
// NormativeTypes/tosca.relationships.Root
// NormativeTypes/tosca.relationships.RoutesTo
// DO NOT EDIT!
...
func toscaCapabilitiesAttachement() (*asset, error) {
	...
	info := bindataFileInfo{name: "tosca.capabilities.Attachement", size: 71, mode: os.FileMode(504), modTime: time.Unix(1433921141, 0)}
...
func toscaCapabilitiesContainer() (*asset, error) {
	...
	info := bindataFileInfo{name: "tosca.capabilities.Container", size: 554, mode: os.FileMode(504), modTime: time.Unix(1433921141, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func toscaCapabilitiesEndpoint() (*asset, error) {
	...
	info := bindataFileInfo{name: "tosca.capabilities.Endpoint", size: 741, mode: os.FileMode(504), modTime: time.Unix(1433921141, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func toscaCapabilitiesEndpointAdmin() (*asset, error) {
	...
	info := bindataFileInfo{name: "tosca.capabilities.Endpoint.Admin", size: 181, mode: os.FileMode(504), modTime: time.Unix(1433921141, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func toscaCapabilitiesEndpointDatabase() (*asset, error) {
	...
	info := bindataFileInfo{name: "tosca.capabilities.Endpoint.Database", size: 86, mode: os.FileMode(504), modTime: time.Unix(1433921141, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func toscaCapabilitiesEndpointPublic() (*asset, error) {
	...
	info := bindataFileInfo{name: "tosca.capabilities.Endpoint.Public", size: 569, mode: os.FileMode(504), modTime: time.Unix(1433921141, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func toscaCapabilitiesNetworkBindable() (*asset, error) {
	...
	info := bindataFileInfo{name: "tosca.capabilities.Network.Bindable", size: 77, mode: os.FileMode(504), modTime: time.Unix(1433921141, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func toscaCapabilitiesNode() (*asset, error) {
	...
	info := bindataFileInfo{name: "tosca.capabilities.Node", size: 65, mode: os.FileMode(504), modTime: time.Unix(1433921141, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func toscaCapabilitiesOperatingsystem() (*asset, error) {
	...
	info := bindataFileInfo{name: "tosca.capabilities.OperatingSystem", size: 314, mode: os.FileMode(504), modTime: time.Unix(1433921141, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func toscaCapabilitiesRoot() (*asset, error) {
	...
	info := bindataFileInfo{name: "tosca.capabilities.Root", size: 121, mode: os.FileMode(504), modTime: time.Unix(1433921141, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func toscaCapabilitiesScalable() (*asset, error) {
	...
	info := bindataFileInfo{name: "tosca.capabilities.Scalable", size: 238, mode: os.FileMode(504), modTime: time.Unix(1433921141, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func toscaInterfacesNodeLifecycleStandard() (*asset, error) {
	...
	info := bindataFileInfo{name: "tosca.interfaces.node.lifecycle.Standard", size: 362, mode: os.FileMode(504), modTime: time.Unix(1433921141, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}

var _toscaInterfacesRelationshipConfigure = []byte("")
...
func toscaInterfacesRelationshipConfigure() (*asset, error) {
	...
	info := bindataFileInfo{name: "tosca.interfaces.relationship.Configure", size: 825, mode: os.FileMode(504), modTime: time.Unix(1451482449, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func toscaNodesBlockstorage() (*asset, error) {
	...
	info := bindataFileInfo{name: "tosca.nodes.BlockStorage", size: 352, mode: os.FileMode(504), modTime: time.Unix(1433921141, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func toscaNodesCompute() (*asset, error) {
	...
	info := bindataFileInfo{name: "tosca.nodes.Compute", size: 912, mode: os.FileMode(504), modTime: time.Unix(1433921141, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func toscaNodesContainerApplication() (*asset, error) {
	...
	info := bindataFileInfo{name: "tosca.nodes.Container.Application", size: 232, mode: os.FileMode(504), modTime: time.Unix(1433921141, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func toscaNodesContainerRuntime() (*asset, error) {
	...
	info := bindataFileInfo{name: "tosca.nodes.Container.Runtime", size: 198, mode: os.FileMode(504), modTime: time.Unix(1433921141, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func toscaNodesDbms() (*asset, error) {
	...
	info := bindataFileInfo{name: "tosca.nodes.DBMS", size: 460, mode: os.FileMode(504), modTime: time.Unix(1433921141, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func toscaNodesDatabase() (*asset, error) {
	...
	info := bindataFileInfo{name: "tosca.nodes.Database", size: 754, mode: os.FileMode(504), modTime: time.Unix(1433921141, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func toscaNodesLoadbalancer() (*asset, error) {
	...
	info := bindataFileInfo{name: "tosca.nodes.LoadBalancer", size: 606, mode: os.FileMode(504), modTime: time.Unix(1433921141, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func toscaNodesObjectstorage() (*asset, error) {
	...
	info := bindataFileInfo{name: "tosca.nodes.ObjectStorage", size: 381, mode: os.FileMode(504), modTime: time.Unix(1433921141, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func toscaNodesRoot() (*asset, error) {
	...
	info := bindataFileInfo{name: "tosca.nodes.Root", size: 572, mode: os.FileMode(504), modTime: time.Unix(1433921141, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func toscaNodesSoftwarecomponent() (*asset, error) {
	...
	info := bindataFileInfo{name: "tosca.nodes.SoftwareComponent", size: 437, mode: os.FileMode(504), modTime: time.Unix(1433921141, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func toscaNodesWebapplication() (*asset, error) {
	...
	info := bindataFileInfo{name: "tosca.nodes.WebApplication", size: 350, mode: os.FileMode(504), modTime: time.Unix(1433921141, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func toscaNodesWebserver() (*asset, error) {
	...
	info := bindataFileInfo{name: "tosca.nodes.WebServer", size: 327, mode: os.FileMode(504), modTime: time.Unix(1433921141, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func toscaRelationshipsAttachesto() (*asset, error) {
	...
	info := bindataFileInfo{name: "tosca.relationships.AttachesTo", size: 272, mode: os.FileMode(504), modTime: time.Unix(1433921141, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func toscaRelationshipsConnectsto() (*asset, error) {
	...
	info := bindataFileInfo{name: "tosca.relationships.ConnectsTo", size: 218, mode: os.FileMode(504), modTime: time.Unix(1433921141, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func toscaRelationshipsDependson() (*asset, error) {
	...
	info := bindataFileInfo{name: "tosca.relationships.DependsOn", size: 122, mode: os.FileMode(504), modTime: time.Unix(1433921141, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func toscaRelationshipsHostedon() (*asset, error) {
	...
	info := bindataFileInfo{name: "tosca.relationships.HostedOn", size: 126, mode: os.FileMode(504), modTime: time.Unix(1433921141, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func toscaRelationshipsRoot() (*asset, error) {
	...
	info := bindataFileInfo{name: "tosca.relationships.Root", size: 289, mode: os.FileMode(504), modTime: time.Unix(1433921141, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func toscaRelationshipsRoutesto() (*asset, error) {
	...
	info := bindataFileInfo{name: "tosca.relationships.RoutesTo", size: 131, mode: os.FileMode(504), modTime: time.Unix(1433921141, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
